...
const contrats = require("../server/routes/contrats.js");
app.use("/api/contrats", contrats);

const interventions = require("../server/routes/interventions.js");
app.use("/api/interventions", interventions);

const clients = require("../server/routes/clients.js");
app.use("/api/clients", clients);

const tickets = require("../server/routes/tickets.js");
app.use("/api/tickets", tickets);

const emplacements = require("../server/routes/emplacements.js");
app.use("/api/emplacements", emplacements);

const stocks = require("../server/routes/stocks.js");
app.use("/api/stocks", stocks);

const pannes = require("../server/routes/pannes.js");
app.use("/api/pannes", pannes);

const diagnostics = require("../server/routes/diagnostics.js");
app.use("/api/diagnostics", diagnostics);

const demandestock = require("../server/routes/demandestock.js");
app.use("/api/demandestock", demandestock);

const acheteurs = require("../server/routes/acheteurs.js");
app.use("/api/acheteurs", acheteurs);

const users = require("../server/routes/users.js");
app.use("/api/users", users);

const accessoires = require("../server/routes/accessoires.js");
app.use("/api/accessoires", accessoires);

const offres = require("../server/routes/offres.js");
app.use("/api/offres", offres);

const revendeurs = require("../server/routes/revendeurs.js");
